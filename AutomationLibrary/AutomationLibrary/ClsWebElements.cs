...
namespace AutomationLibrary
{
    public class ClsWebElements
    {
        ...
        public static bool fnPageLoad(IWebElement pobjWebElement, string pstrPage, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "PageLoad Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("PageLoadFail", "The Page is not loaded for the Page: " + pstrPage, Status.Fail, true); //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("PageLoadFail", "The Page is not loaded for the Page: " + pstrPage, Status.Warning, true);
                fnExceptionHandling(pobjException);
            }
            return blResult;
        }
        ...
        public static bool fnSendKeys(IWebElement pobjWebElement, string pstrField, string pstrTextEnter, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "SendKeys Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("SendKeysFail", "The SendKeys for: " + pstrField + " with value: " + pstrTextEnter + " has failed.", Status.Fail, true); //Removing FAIL status per Sekhar Request
        ...
        public static bool fnClick(IWebElement pobjWebElement, string pstrElement, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "Click Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("ClickFail", "The click to the element is not working for: " + pstrElement, Status.Fail, true); //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("ClickFail", "The click to the element is not working for: " + pstrElement, Status.Warning, true);
                fnExceptionHandling(pobjException);
            }
            return blResult;
        }
        ...
        public static bool fnDoubleClick(IWebElement pobjWebElement, string pstrElement, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "DoubleClick Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("DoubleClickPass", "Couldn't Double Click on " + pstrElement, Status.Fail, true); //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("DoubleClickPass", "Couldn't Double Click on " + pstrElement, Status.Warning, true);
                fnExceptionHandling(pobjException);
            }
            return blResult;
        }
        ...
        public static string fnGetAttribute(IWebElement pobjWebElement, string pstrElement, string pstrAttName, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "GetAttribute Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("GetAttributeFail", "Get Attribute " + pstrAttName + " from Element: " + pstrElement + " was not done.", Status.Fail, false); //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("GetAttributeFail", "Get Attribute " + pstrAttName + " from Element: " + pstrElement + " was not done.", Status.Warning, false);
                fnExceptionHandling(pobjException);
            }
        ...
        public static bool fnSelectList(string pstrStepName, IWebElement pobjWebElement, string pstrValue, string pstrValueType = "value", bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "Select List Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("SelectListFail", pstrStepName, Status.Fail, true);  //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("SelectListFail", pstrStepName, Status.Warning, true);
                fnExceptionHandling(pobjException);
            }
            return blResult;
        }
        ...
        public static bool fnSelectCheckBox(string pstrStepName, IWebElement pobjWebElement, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "Select CheckBox Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("SelectCheckBoxFail", pstrStepName, Status.Warning, true); //Removing FAIL status perr Sekhar Request
        ...
        public static bool fnVerifyList(string pstrStepName, IWebElement pobjWebElement, string[] pstrListValues, string pstrListType = "option", bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "Verify List Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("VerifyListPass", "Some Elements from the List are not Displayed", Status.Fail, pblScreenShot);  //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("VerifyListPass", "Some Elements from the List are not Displayed", Status.Warning, pblScreenShot);
                fnExceptionHandling(pobjException, pstrStepName);
            }
            return blResult;
        }
        ...
        public static void fnScrollToV2(IWebElement pobjWebElement, string pstrField, bool pblScreenShot = true, bool pblHardStop = false, string pstrHardStopMsg = "Scroll To Failed and HardStop defined")
        {
            ...
            {
                //ClsReportResult.fnLog("ScrollToFailed", "Failed Scroll to element: " + pstrField, Status.Fail, true); //Removing FAIL status perr Sekhar Request
                ClsReportResult.fnLog("ScrollToFailed", "Failed Scroll to element: " + pstrField, Status.Warning, true);
                fnExceptionHandling(pobjException);
            }
        }
        ...
        /// <param name="driver">The WebDriver</param>
        /// <param name="element">The elelemt to scroll to</param>
        public static void fnJsScrollToIntoMiddle(IWebElement pobjWebElement, string pstrField, bool pblScreenShot = true, bool blSkipReport = false)
        {
            try
            {
                if (!blSkipReport) { ClsReportResult.fnLog("ScrollTo", "Step - Scroll to element: " + pstrField, Status.Info, false); }
                ...
                if (!blSkipReport) { ClsReportResult.fnLog("ScrollToPass", "Scrolled to element: " + pstrField, Status.Pass, pblScreenShot); }
            }
            catch (Exception pobjException)
            {
                //ClsReportResult.fnLog("ScrollToFailed", "Failed Scroll to element: " + pstrField, Status.Fail, true);  //Removing FAIL status perr Sekhar Request
        ...
        public static void fnExceptionHandling(Exception pobjException, string pstrStepName = "", bool pblHardStop = false, string pstrHardStopMsg = "Failed Step and HardStop defined")
        {
            ...
            {
                case "SendKeysFail":
                    ClsReportResult.fnLog("SendKeysFail", "SendKeys action Fail", Status.Warning, true);
                    break;
                case "ClearFail":
                ...
                case "ContainsTextFail":
                    ...
                    break;
                case "VerifyTextFail":
                    ClsReportResult.fnLog("VerifyTextFail", "Verify text verification failed", Status.Warning, true);
                    break;
                case "VerifySelectedItemFail":
                    ClsReportResult.fnLog("SelectedItemFail", "Coverage selected verification failed", Status.Warning, true);
                    break;
                case "SelectRadioBtnFail":
                    ClsReportResult.fnLog("SelectRadioBtnFail", "Select Radio Button verification failed", Status.Warning, true);
                    break;
